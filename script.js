...
"amber",  "ash", "azure", "bamboo", "beech", "beige", "black", "blonde", "blue", "bone", "brass", "brick", "bronze", "brown", "canvas", "cerise", "chalk", "cheese", "chrome", "clay", "cloth", "copper", "cork", "cotton", "cream", "cyan", "denim", "ebony", "flax", "flaxen", "flint", "fur", "ginger", "glass", "gold", "golden", "green", "grey", "ice", "iced", "indigo", "iron", "ivory", "jade", "khaki", "lace", "lacy", "lead", "lilac", "linen", "maroon", "mauve", "metal", "midget", "nickel", "nylon", "oak", "orange", "paper", "pewter", "pine", "pink", "purple", "quartz", "red", "rock", "rocky", "rubber", "ruby", "sepia", "shell", "silk", "silken", "silver", "slate",  "snow", "sponge", "steel", "stone", "straw", "suede", "tan", "tin", "velvet", "violet", "wax", "white", "wire", "wiry", "wood", "wooden", "wool", "yellow", "zinc" 
        );
